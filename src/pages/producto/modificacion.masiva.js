...
export const ProductosModificacionMasiva = () => {
  ...
  return (
    <div className='p-5'>
      <h2 className="text-2xl font-medium mb-2">Modificación masiva de productos</h2>
      <span>Todos los campos son editables. Para guardar los cambios realizados presione el botón al final de la tabla "Guardar cambios"</span>
